...
for p in range(len(pts)):
    for i in range(1,4):
        # print("{}{}_{{ignore}} = ({}, 3.83)".format(pts[p], i, ptsNum[p]))
        # print("Pplu4_{ignore} = (18.66, 3.83)")
        # listPts.append("{}{}".format(pts[p], i))
        print("Rename({}{}_{{ignore}}, {}{})".format(pts[p], i, pts[p], i))
# print(listPts)
...
#         print("If(IsInRegion( {}, {}_{{ignore}} ) == true, SetCoords({}, x({}_{{ignore}}), y({}_{{ignore}})))".format(listPts[p], Cic[c], listPts[p], ptCs[c], ptCs[c]))
#
#     print("\n")
